...
var
    MyGlobalVariable: Integer; // Global 'Integer' variable 'MyGlobalVariable' is only used in 'ShowValue' and appears to be reinitialized before every read. Consider moving it to local scope. [LC0100]
...
For immutable labels, the message omits the reinitialization wording: `Global 'Label' variable 'MyLabel' is only used in 'ShowMessage'. Consider moving it to local scope.`
