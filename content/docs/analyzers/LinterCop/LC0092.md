...
| Variable | Must start with an uppercase letter; must not contain %, &, !, ? | Local and global variables |
| Parameter | Must start with an uppercase letter | Procedure parameters |
