...
|---|---|---|---|---|
| [LC0003](lc0003/) | Object ID should not be in declaration | Info | ✓ | ✓ |
| [LC0007](lc0007/) | Maintainability Index metric | Info | ✓ | |
...
| [LC0019](lc0019/) | DataClassification redundancy | Info | ✓ | ✓ |
| [LC0020](lc0020/) | ApplicationArea redundancy | Info | ✓ | ✓ |
| [LC0028](lc0028/) | Identifiers in event subscribers | Warning | ✓ | |
| [LC0031](lc0031/) | Record instance isolation level | Warning | ✓ | ✓ |
| [LC0033](lc0033/) | App manifest runtime behind | Warning | ✓ | |
| [LC0040](lc0040/) | Explicitly set RunTrigger | Info | ✓ | |
| [LC0043](lc0043/) | Use SecretText for sensitive text | Warning | ✓ | |
| [LC0048](lc0048/) | Error invocation using text constant | Warning | ✓ | |
| [LC0052](lc0052/) | Internal procedure not referenced | Warning | ✓ | |
| [LC0053](lc0053/) | Internal procedure only used in current object | Info | ✓ | |
| [LC0054](lc0054/) | Interface object name guide | Info | ✓ | |
| [LC0063](lc0063/) | API page canonical field name guide | Info | ✓ | |
| [LC0081](lc0081/) | Use IsEmpty method instead of Count | Info | ✓ | |
| [LC0082](lc0082/) | Use Query or Find with Next instead of Count | Info | ✓ | |
| [LC0083](lc0083/) | Use built-in date/time methods | Info | ✓ | ✓ |
