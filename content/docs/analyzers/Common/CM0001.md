...
Load failures are cached for the analyzer session. After fixing the source, restart the analyzer process; in VS Code, use **Developer: Reload Window**. The warning disappears when the configuration loads cleanly in the new session.
