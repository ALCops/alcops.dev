...
FC0004 enforces the following order. The code fix reorders entries to match (see [Code fix](#code-fix)):
...
This sort order is compatible with the **Sort Permissions** command of the [AZ AL Dev Tools](https://marketplace.visualstudio.com/items?itemName=andrzejzwierzchowski.al-code-outline) extension. Code sorted by either tool satisfies the rule.
