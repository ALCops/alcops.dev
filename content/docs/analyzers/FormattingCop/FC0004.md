+++
title = 'Permission declarations should be ordered alphabetically'
linkTitle = 'FC0004'
...
permissionset 50100 "Sales Permissions"
{
    ...
    Permissions = tabledata "Sales Header" = R,
                  ...
                  page "Sales Order" = X,
                  tabledata Customer = R; // Permission declarations should be ordered alphabetically [FC0004]
}
{{< /highlight >}}
...
- [AC0031](../../applicationcop/ac0031/) and [AC0032](../../applicationcop/ac0032/) validate the correctness of permission entries. FC0004 validates their ordering.
