...
- Setup tables are excluded — tables whose only primary key field is a `Code` field named "Primary Key", or that declare a parameterless `GetRecordOnce` procedure.
